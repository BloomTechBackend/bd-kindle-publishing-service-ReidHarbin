...
Amazon Kindle Publishing Service, an AWS service that provides the ability to publish books to the Kindle catalog, 
access published Kindle books in the catalog, and remove published Kindle books from the catalog.

(This a project completed through the Bloom Institute of Technology)
...
## Kindle Publishing Service API Implementation
...
![Link to sequence diagram PUML file](src/resources/mastery-task1-remove-book-SD.png)
